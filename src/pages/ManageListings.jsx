          ...
          <li key={index} className="listing-item">
            ...
            <div className="listing-details">
              ...
              <div className="listing-actions">
                ...
                <button style={{backgroundColor: 'red'}} onClick={() => handleDelete(index)}>Delete <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash" viewBox="0 0 16 16">
